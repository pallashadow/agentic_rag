...
This document explains how the data in `data/data_miles/` directory is generated and what each file/folder contains.

## Overview

The data preparation process follows a pipeline that transforms raw web documents into structured data suitable for RAG (Retrieval-Augmented Generation) search and indexing. The complete pipeline is defined in `scripts/data_prepare_miles.ipynb` (and similarly named notebooks for other datasets).
...
**Output:**
- Directory: `data/data_miles/documents/`
...
**Output:**
- Directory: `data/data_miles/chunks/`
...
chunker = NaiveChunker(
    input_dir="./data/data_miles/documents/",
    output_dir="./data/data_miles/chunks/",
    chunk_size=500,
    chunk_overlap=100,
    reload=False
)
...
**Output:**
- File: `data/data_miles/titles.json`
...
extractor = TitleExtractor(
    input_dir="./data/data_miles/documents/",
    output_file="./data/data_miles/titles.json"
)
extractor.run()
```
...
**Output:**
- File: `data/data_miles/summaries.json`
...
extractor = SummaryExtractor(
    input_dir="./data/data_miles/documents/",
    output_file="./data/data_miles/summaries.json",
    max_workers=8,
    limit=None
)
...
**Output:**
- Directory: `data/data_miles/contexts/`
...
contexter = ContextGenerator(
    chunks_folder="./data/data_miles/chunks/",
    summaries_path="./data/data_miles/summaries.json",
    output_folder="./data/data_miles/contexts/",
    limit=None,
    skip_existing=True,
    context_step=2
)
