...
export function buildEndpointUrl(cloudBase) {
...
export function setStatus(statusPill, text, isError = false) {
...
export async function typewriterEffect(messages, element, text, speed = 20) {
    element.textContent = "";
...
export async function fetchAuthTokenFromBackend(baseUrlRaw) {
